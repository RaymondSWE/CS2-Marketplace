...
const DiscountedSkinPreview = () => {
  ...
  // Sort skins by discount percentage in ascending order
  const sortedSkins = [...skins].sort((a, b) => {
    const discountA = parseFloat(calculateDiscount(a.listed_price, a.price));
    const discountB = parseFloat(calculateDiscount(b.listed_price, b.price));
  ...
  return (
    <div className="skin-preview-container">
      <h2 className="skin-preview-title">Highest Discounts</h2>
...
export default DiscountedSkinPreview;
