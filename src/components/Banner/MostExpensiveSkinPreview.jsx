...
const MostExpensiveSkinPreview = () => {
  const skins = useSkins(1);
  const sortedSkins = [...skins].sort(
    (a, b) => parseFloat(b.listed_price) - parseFloat(a.listed_price)
  );
  ...
  return (
    <div className="skin-preview-container">
      <h2 className="skin-preview-title">Higest Tier Weapon</h2>
...
export default MostExpensiveSkinPreview;
